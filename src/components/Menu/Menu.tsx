    ...
    <>
      <div className='menu' tabIndex={0} onKeyUp={(event) => handleInput(event)} ref={mainMenu}>
        ...
        <div className="menu-grid">
          <div className={'menu-item--left'}> <h3><Link to={"/pin/intro"}>7) New PIN code</Link></h3></div>
          <div className={'menu-item--right'}><h3><Link to={"/faktura/intro"}>9) Pay invoice</Link></h3></div>
          <div className={'menu-item--left'}><h3><Link to={BOARD_PIN_PATH}>1) Top 30 - New PIN code</Link></h3></div>
          <div className={'menu-item--right'}> <h3><Link to={BOARD_PAY_PATH}>3) Top 30 - Pay invoice</Link></h3></div>
